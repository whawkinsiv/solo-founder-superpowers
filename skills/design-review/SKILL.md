...
For visual principles (hierarchy, whitespace, composition), reference the **beautify** skill. For specific AI-generated antipatterns, reference **beautify/AI-SLOP-FIXES.md**. For component and layout implementation, reference **ui-patterns**.
